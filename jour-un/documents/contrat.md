...
- le logo retenu parmi les propositions, au format vectoriel (SVG) ;
- une carte de visite au format PDF, prête à imprimer ;
- l'accompagnement à la création de la fiche Google Business Profile du Client, sur le compte Google du Client, ainsi que 4 publications.
...
## 4. Propriété
Après paiement, le Client est propriétaire de son nom de domaine, de son logo, des textes et des fichiers de son site.
Sa fiche Google lui appartient dès sa création.

## 5. Engagements
Le Prestataire s'engage à fournir les prestations avec soin (obligation de moyens). Le classement dans les résultats de
Google dépend de Google, et **aucune position n'est garantie**. Le Prestataire ne publie ni ne sollicite jamais de faux avis.
