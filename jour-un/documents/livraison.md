...
## 1. Encaisser
- [ ] Paiement reçu via ton lien Stripe (149 €) et facture envoyée (Stripe peut la générer).
- [ ] Statut « Client » dans le cockpit.
- [ ] S'il prend le suivi : lien d'abonnement Stripe à 29 €/mois, puis ajout dans `automatisation/clients.json`.
...
- [ ] Le nom de domaine qu'il veut (ex. : `plomberie-durand.fr`).
...
- [ ] Acheter son nom de domaine (~10 €/an, chez OVH, Gandi ou Netlify) **à son nom**, et le brancher sur Netlify.
...
- [ ] Lui demander un avis ou un témoignage, et s'il connaît d'autres créateurs (parrainage : 20 € offerts par filleul qui achète).
